...
INSERT INTO "MEMBER"
VALUES(SEQ_MEMBER_NO.NEXTVAL,'member2','pass02!', 
			'member01@kh.or.kr',
			'닉네임2','샘플2',  NULL, DEFAULT, DEFAULT, NULL
			, NULL, DEFAULT, DEFAULT, DEFAULT);
...
ALTER TABLE "MARKER" ADD CONSTRAINT "PK_MARKER" PRIMARY KEY (
	"MEMBER_NO",
	"BOARD_NO"
);
...
ALTER TABLE "MARKER" ADD CONSTRAINT "FK_MEMBER_TO_MARKER_1" FOREIGN KEY (
	"MEMBER_NO"
)
REFERENCES "MEMBER" (
	"MEMBER_NO"
...
ALTER TABLE "MARKER" ADD CONSTRAINT "FK_BOARD_TO_MARKER_1" FOREIGN KEY (
	"BOARD_NO"
)
REFERENCES "BOARD" (
	"BOARD_NO"
