...
SELECT * FROM TB_TEST;
-- 시퀀스 이용시 중복되지 않는 식별자 PK를 만들기 좋다
...
-- '짱구'의 PK 컬럼 값을
-- SEQ_TEST_NO 시퀀스의 다음 다음 생성 값으로 변경하기
UPDATE TB_TEST
SET
