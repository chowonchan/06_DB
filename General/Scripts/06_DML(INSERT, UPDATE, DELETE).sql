...
-- 서브 쿼리를 이용해서 여러행 INSERT하기
--> 서브 쿼리 결과(RESULT SET)를 통째로 삽입하기
INSERT INTO EMP_01
(SELECT 
			EMP_ID,
			EMP_NAME,
...
MERGE INTO EMP_M01 USING EMP_M02 ON(EMP_M01.EMP_ID = EMP_M02.EMP_ID) -- 중복 확인 KEY
-- 1번 테이블 기준으로 병합 ( 2번 테이블 사용 )
...
SELECT * FROM EMP_M01;
-- 급여가 0원 인 경우 M02 테이블과 병합된것, 곽두원은 새로 INSERT 되었다
